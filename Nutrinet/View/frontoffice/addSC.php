...
<a href="listCoachingSessions.php">Back to list</a>
    ...
    <form id="coachingSessionForm" action="" method="POST">
        <table class="table">
            <tr>
                <td><label for="duree" class="form-label">Durée (en minutes):</label></td>
                <td>
                    <input type="text" id="duree" name="duree" class="form-control" />
                </td>
            </tr>
            <tr>
                <td><label for="acces" class="form-label">Accès:</label></td>
                <td>
            ...
            <tr>
                <td><label for="sujet" class="form-label">Sujet:</label></td>
                <td>
                    <textarea id="sujet" name="sujet" class="form-control"></textarea>
                </td>
            </tr>
            <tr id="codeRow">
