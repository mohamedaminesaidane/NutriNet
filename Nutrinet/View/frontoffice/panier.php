...
<html lang="en">
         ...
         <table class="table">
            ...
            <tbody id="panier-body">
               ...
               <td><?= $panier['nom']; ?></td>
                  ...
                  <td>
                     <a class="btn btn-danger" href="deletePanier.php?idPanier=<?php echo $panier['idPanier']; ?>">Supprimer</a>&nbsp;
                     <a href="updatePanier.php?idPanier=<?php echo $panier['idPanier']; ?>" class="btn btn-primary">Modifier</a>
                  </td>
               </tr>
               <?php endforeach; ?>
            </tbody>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    function sortTable(columnIndex) {
      ...
      table = document.getElementById("panier-body");
      switching = true;
    ...
    makeSortable();
         ...
         <form method="POST" action="">
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" id="idItems" name="idItems">
            </div>
            <div class="form-group">
            ...
            <br>
            <button type="submit" class="btn btn-primary" style="margin-right: 70%">Ajouter au panier</button>
            <a href="formulaire.php" class="btn btn-primary">Commander</a>
         </form>
         <br>
      </div>
