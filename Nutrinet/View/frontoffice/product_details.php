...
if (isset($_GET['idProduit'])) {
    ...
    $productDetails = $c->showProduit($productId);

    // Check if the product exists
    if ($productDetails && isset($productDetails['idProduit'])) {
?>
<!DOCTYPE html>
<html lang="en">
   <head>
...
<link rel="stylesheet" href="css/product.css">
   ...
   <div class="banner_bg_main">
    ...
    <img src="../backoffice/pages/image/<?php echo htmlspecialchars($productDetails['image']); ?>" alt="<?php echo htmlspecialchars($productDetails['nom']); ?>">
</div>

                </div>
                <div class="col-lg-6 align-self-center">
                    <h4><?php echo $productDetails['nom']; ?></h4>
                    <span class="price">Prix:  <?php echo $productDetails['prixVente']; ?></span>
               ...
               <ul>
                 <li><span>Product ID:</span> whey</li>
                 <li><span>Saveur:</span> <a >Double Chocolaten</a>, <a >Vanilla Ice Cream</a>, <a >Strawberry Cream</a></li>
                 <li><span>Format:</span> <a >900g</a>, <a >1.8kg</a></li>
               </ul>
             </div>
             <div class="col-lg-12">
               <div class="sep"></div>
           ...
           <div class="row">
             ...
             <div class="col-lg col-sm-6 col-xs-12">
               <div class="item">
                 <h4>PROTEIN</h4>
                 <div class="thumb">
                   <a href="product-details.html"><img src="images/ppp.png" alt=""></a>
                 </div>
               </div>
             </div>
             <div class="col-lg col-sm-6 col-xs-12">
             ...
             <div class="col-lg col-sm-6 col-xs-12">
               <div class="item">
                 <h4>SEANCE COATCHING</h4>
                 <div class="thumb">
                   <a href="product-details.html"><img src="images/banner.jpg" alt=""></a>
                 </div>
               </div>
             </div>
             <div class="col-lg col-sm-6 col-xs-12">
               <div class="item">
                 <h4>vitamines</h4>
                 <div class="thumb">
                   <a href="product-details.html"><img src="images/vit3.jpeg" alt=""></a>
                 </div>
               </div>
             </div>
             <div class="col-lg col-sm-6 col-xs-12">
