        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="<?=$currentUser['photo']?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
        ...
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">photo:</strong>
              <input type="file" name="photo" value=<?=$currentUser['photo']?>></li>
              ...
              <input type="text" name="name" value=<?=$currentUser['name']?>></li>
                ...
                <input type="text" name="address" value=<?=$currentUser['address']?>></li>


                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Role:</strong> 
                <input type="text" name="role" value=<?=$currentUser['role']?>></li>




                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Password:</strong> 
                <input type="password" name="password"value=<?=$currentUser['password']?>></li>
