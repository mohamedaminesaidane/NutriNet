...
if (
  ...
  if (
      ...
      $reclamC->updateReclam($reclam, $reclam_id);
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="../../frontoffice/reclam.php";>
                        <em class="material-icons text-sm">add</em> Ajouter Reclamation</a>
                    </div>
                  </div>
                </div>
    ...
    <div class="row d-flex align-items-center justify-content-center">
        <div class="col-lg-8">
            ...
            <?php
if (isset($reclam_id)) {
    $oldReclam = $reclamC->showReclam($reclam_id);
?>
    <form method="POST" class="form">
        <div class="form-group">
            <label for="Nom">Id:</label>
            <input type="text" class="form-control" id="ID_reclam" name="ID_reclam" placeholder="id" value="<?php echo $reclam_id ?>" readonly />
        </div>
        <div class="form-group">
            <label for="Nom">Your Name:</label>
            <input type="text" class="form-control" id="Nom" name="Nom" placeholder="Name" value="<?php echo $oldReclam['Nom']?>" readonly />
        </div>
        <div class="form-group">
            <label for="title">Reclamation Title:</label>
            <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?php echo $oldReclam['title']?>" readonly />
        </div>
        <div class="form-group">
          <label for="description">Reclamation Description:</label>
          <textarea readonly class="form-control" id="description" name="description" placeholder="Description" rows="4"><?php echo $oldReclam['description']; ?></textarea>
        </div>
        <div class="form-group">
          <label for="Mail">Your Mail:</label>
            <input type="text" class="form-control" id="Mail" name="Mail" placeholder="Mail" value="<?php echo $oldReclam['Mail']; ?>" readonly />
            <small id="MailHelp" class="form-text text-muted">Please enter a valid Mail address.</small>
          </div>
          <div class="form-group">
            <label for="date">Reclamation Date:</label>
            <input type="date" class="form-control" id="date" name="date" value="<?php echo $oldReclam['date']?>" readonly />
          </div>
          
          <div class="form-group">
              <label for="Category">Choose Category:</label>
              <select class="form-control" id="Category" name="Category">
                  <option value="seances_coaching" <?php if($oldReclam['Category'] === 'seances_coaching') echo 'selected'; ?>>Séances de coaching</option>
                  <option value="seances_recette" <?php if($oldReclam['Category'] === 'seances_recette') echo 'selected'; ?>>Les recette</option>
                  <option value="produits" <?php if($oldReclam['Category'] === 'produits') echo 'selected'; ?>>Produits</option>
                  <option value="other" <?php if($oldReclam['Category'] === 'other') echo 'selected'; ?>>Other</option>
              </select>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="Status" name="Status">
              <option value="New" <?php if($oldReclam['Status'] === 'New') echo 'selected'; ?>>New</option>
              <option value="Running" <?php if($oldReclam['Status'] === 'Running') echo 'selected'; ?>>Running</option>
              <option value="Complete" <?php if($oldReclam['Status'] === 'Complete') echo 'selected'; ?>>Complete</option>
            </select>
          </div>
        <button type="submit" class="btn btn-primary" style="background-color: #CEE452; color: #fff;">Update Reclamation</button>
      </form> 
<?php
}
?>
