...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
        ...
        if (
            ...
            $ItemsC->updateItems($Items,$_GET['IdItems']);
                  ...
                  <div class="card-body pt-4 p-3">
                    ...
                    <ul class="list-group">
                      ...
                      if (isset($_GET['IdItems'])) {
                          $Items = $ItemsC->showItems($_GET['IdItems']);
                      ?>
                      <form  method="post">
                          <label for="nom">Nom:</label>
                          <input type="text" id="nom" name="nom" value="<?php echo $Items['nom']; ?>" required><br>
                      
                          <label for="description">description:</label>
                          <input type="text" id="description" name="description" value="<?php echo $Items['description']; ?>" required><br>
                      
                          <label for="prix">prix:</label>
                          <input type="text" id="prix" name="prix" value="<?php echo $Items['prix']; ?>" required><br>
                      
                          <label for="stock">stock:</label>
                          <input type="text" id="stock" name="stock" value="<?php echo $Items['stock']; ?>" required><br>
