<?php
// Include your configuration and necessary PHP files here
include '../../../Controller/produitc.php';
include '../../../Model/produit.php';
include '../../../Model/categorie.php';

$produitC = new ProduitC();
$chartData = $produitC->listProduitsSortedByNombreWithCategories();
$chart= $produitC->listProduitsSortedByProfitsWithNames();
?>
...
<body class="g-sidenav-show bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
      <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/chart_data.php">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-6 mb-4">
            <div class="card">
              <div class="card-body">
                <canvas id="productProfitsChart" width="600" height="400"></canvas>
              </div>
            </div>
          </div>
        </div>
...
<script src="../assets/js/core/popper.min.js"></script>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const categories = chartData.map(item => item.catNom);
        const totalQuantities = chartData.map(item => item.totalQuantity);

        // Create a bar chart for the first chart
        ...
        const productNames = chart.map(item => item.productName);
        const totalProfits = chart.map(item => item.totalProfits);

        // Create the second line chart
        var ctx2 = document.getElementById('productProfitsChart').getContext('2d');
