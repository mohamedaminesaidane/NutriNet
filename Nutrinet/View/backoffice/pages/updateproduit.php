...
<table border="1" align="center" width="60%">
    ...
    ?>
        <tr>
            ...
            ?>
            <td><?= $cat['nom']; ?></td>
            <td><img style="max-width: 50px;max-height=50px" src="./image/<?php echo $produit['image']; ?>"></td>
            <td>
                <a class="btn btn-primary" href="updateProduit.php?idProduit=<?php echo $produit['idProduit']; ?>">Update</a>
            </td>
            <td>
                <a class="btn btn-danger" href="deleteproduit.php?idProduit=<?php echo $produit['idProduit']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
    ...
    ?>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <tr><td><button class="btn bg-gradient-dark"><a href="produit.php">Back to list</a></button></td></tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" id="image" name="image" value="<?php echo $oldProduit['image'] ?>" />
                    </td>
                </tr>
                <tr>
