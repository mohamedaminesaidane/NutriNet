...
if (
  ...
  if (
    ...
    $response = new Response(
      ...
      $responseC->upDateResponse($response, $response_id);
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Response</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Response</h6>
        </nav>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="../../frontoffice/reclam.php";>
                        <em class="material-icons text-sm">add</em> Ajouter Response</a>
                    </div>
                  </div>
                </div>
    ...
    <div class="row d-flex align-items-center justify-content-center">
        <div class="col-lg-8">
            <h2 class="">Update Response</h2>
            <?php
if (isset($response_id)) {
    $oldResponse = $responseC->showResponse($response_id);
?>
    <form method="POST" class="form">
        <div class="form-group">
            <label for="Nom">Id:</label>
            <input type="text" class="form-control" id="ID_Response" name="ID_Response" placeholder="id" value="<?php echo $response_id ?>" readonly />
        </div>
        
                  <div class="form-group">
                    <label for="Nom">Id:</label>
                    <input type="text" class="form-control" id="ID_reclam" name="ID_reclam" placeholder="id"value="<?php echo $oldResponse['ID_reclam']; ?>" readonly />
                </div>
        <div class="form-group">
            <label for="Nom">Your Name:</label>
            <input type="text" class="form-control" id="Nom" name="Nom" placeholder="Name" value="<?php echo $oldResponse['Nom']?>"  />
        </div>
        <div class="form-group">
            <label for="Title">Response Title:</label>
            <input type="text" class="form-control" id="Title" name="Title" placeholder="Title" value="<?php echo $oldResponse['Title']?>"  />
        </div>
        <div class="form-group">
          <label for="Message">Response Message:</label>
          <textarea  class="form-control" id="Message" name="Message" placeholder="Message" rows="4"><?php echo $oldResponse['Message']; ?></textarea>
        </div>
        <div class="form-group">
          <label for="Mail">Your Mail:</label>
            <input type="text" class="form-control" id="Mail" name="Mail" placeholder="Mail" value="<?php echo $oldResponse['Mail']; ?>"  />
            <small id="MailHelp" class="form-text text-muted">Please enter a valid Mail address.</small>
          </div>
        <button type="submit" class="btn bg-gradient-dark mb-0"">Update Response</button>
      </form> 
<?php
}
?>
