...
$tab = $c->listProduits();
$catc = new CategorieC(); // Utilisez la méthode listProduits
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <style>
    /* Ajoutez ce style pour la pagination */
    .pagination {
      display: flex;
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <h2><a href="ajoutprod.php">Add Product</a> </h2>
    <h2><a href="downloadprod.php">Download List</a></h2>
</center>
