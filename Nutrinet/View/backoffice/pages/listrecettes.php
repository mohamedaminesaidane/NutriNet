        ...
        <div class="col-lg-12">
          <div class="row">
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-6 d-flex align-items-center">
                      <h6 class="mb-0">nos recettes</h6>
                    </div>
                    <div class="col-6 text-end">
                    <a class="btn bg-gradient-dark mb-0" href="addrecette.php">
                      <em class="material-icons text-sm">add</em> Ajouter Recette
                    </a>
            ...
            <center>
                ...
                <h2>
                    <a href="addrecette.php">Ajouter recette</a>
                </h2>
            </center>
                  ...
                  <tbody>
                      ...
                      ?>
                          <tr>
                              ...
                              <td><?= $recette['url']; ?></td>
                              <td><?= $recette['video_id']; ?></td>
                              <td><?= $recette['ingredients']; ?></td>
                              <td>
                                  <a class="btn btn-primary btn-sm" href="updaterecette.php?id=<?= $recette['id']; ?>">Update</a>
                                  <a class="btn btn-danger btn-sm" href="deleterecette.php?id=<?= $recette['id']; ?>">Delete</a>
                              </td>
                          </tr>
                      <?php
                      }
