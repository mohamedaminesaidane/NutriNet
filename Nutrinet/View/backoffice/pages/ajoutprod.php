...
$produitC = new ProduitC();
      ...
      
    {
      ...
      $produit = new Produit( null,$_POST["nom"], $_POST["prixVente"],$_POST["prixAchat"], $_POST["description"], $_POST["nombre"], $filename,$_POST["cat"]);
...
<script src="ajoutproduit.js" defer></script>
<!DOCTYPE html>
<html lang="en">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/ajoutprod.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajouter Produit</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Ajouter Produit</h6>
        </nav>
        ...
        <form action="" method="POST" class="form" onsubmit="return validateForm()" enctype="multipart/form-data" >

                      
                            <div class="input-box">
                                <label>Nom</label>
                                <input type="text" id="nom" name="nom" placeholder="Enter le Nom">
                              </div>
                      
                              <div class="input-box">
                                <label>Prix de Vente</label>
                                <input type="float" id="prixVente" name="prixVente" placeholder="Enter le Prix de Vente">
                              </div>
                      
                              <div class="input-box">
                                <label>Prix d'Achat</label>
                                <input type="float" id="prixAchat" name="prixAchat" placeholder="Enter le Prix d'Achat" >
                              </div>
                      
                              <div class="input-box">
                                <label>Description</label>
                                <textarea id="description" name="description"  rows="5" cols="80" placeholder="Enter description" ></textarea>
                              </div>
                      
                              <div class="input-box">
                                <label>Nombre</label>
                                <input type="number" id="nombre" name="nombre"  placeholder="Enter le Nombre" >
                              </div>
                              <div class="input-box">
                                <label>Image</label>
                              ...
                              <div class="input-box">
                                ...
                                <?php foreach ($catc->listCategories() as $cat) { ?>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-md-12 mb-lg-0 mb-4"> </div>
          </div>
        </div>
