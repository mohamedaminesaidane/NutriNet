<?php
include "../../../Controller/categoriec.php"; // Assurez-vous que le chemin est correct

$c = new CategorieC(); // Utilisez la classe ProduitC
$tab = $c->listCategories(); // Utilisez la méthode listProduits
...
if (
    ...
    if (
        ...
        $catc->updateCategorie($cat, $_GET['id_cat']);
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <h2>
        <a href="ajoutcat.php">Add Categorie</a> <!-- Assurez-vous que le lien pointe vers le bon fichier -->
    </h2>
</center>
<table border="1" align="center" width="60%">
    ...
    ?>
        <tr>
            ...
            <td><?= $Categorie['nom']; ?></td>
            <td>
                <a class="btn btn-primary" href="updatecat.php?id_cat=<?php echo $Categorie['id_cat']; ?>">Update</a>
            </td>
            <td>
                <a class="btn btn-danger" href="deletecat.php?id_cat=<?php echo $Categorie['id_cat']; ?>">Delete</a>
            </td>
        </tr>
    <?php
    }
    ...
    if (isset($_GET['id_cat'])) {
        $oldProduit = $catc->showCategorie($_GET['id_cat']);
    ?>

        <form action="" method="POST" enctype="multipart/form-data">
            <table border="1" align="center" width="40%">
            <tr><td><button class="btn bg-gradient-dark"><a href="categories.php">Back to list</a></button></td></tr>
                <tr>
                    <td><label for="nom">id_cat :</label></td>
                    <td>
                        <input type="number" id="id_cat" name="id_cat" value="<?php echo $_GET['id_cat'] ?>" readonly />
                    </td>
                </tr>
                <tr>
